...
export const TRANSLATIONS = {
  'zh-CN': {
    ...
    disclaimerText: "本文件及其内容仅供参考，并非保险合约的一部分，亦不构成购买保险产品的要约或招揽。本文件中列出的预期回报数字（包括红利及分红）均为非保证并可能随时变更，实际回报可能高于或低于此处所示。保单持有人须承担相关信贷及市场风险。有关详细条款及细则，请参阅正式保单文件。预缴利率受市场波动影响，并非保证。",
    startYear: "第",
    endYear: "年起",
    year: "年",
    to: "至",
  ...
  'zh-HK': {
    ...
    disclaimerText: "本文件及其內容僅供參考，並非保險合約的一部分，亦不構成購買保險產品的要約或招攬。本文件中列出的預期回報數字（包括紅利及分紅）均為非保證並可能隨時變更，實際回報可能高於或低於此處所示。保單持有人須承擔相關信貸及市場風險。有關詳細條款及細則，請參閱正式保單文件。預繳利率受市場波動影響，並非保證。",
    startYear: "第",
    endYear: "年起",
    year: "年",
    to: "至",
